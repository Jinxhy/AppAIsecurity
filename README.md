...
![user_cases](figures/rq1.png)*Fig. 1. Optimized on-device deep learning models for common mobile and edge use cases from https://www.tensorflow.org/lite/models*
